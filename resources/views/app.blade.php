  ...
  <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 pad-free">
    <div class="maintab-content" id="v-pills-tabContent">
      ...
      <section>
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1200px;height:120px;overflow:hidden;" class="top_ad_slider">        
        </div>
        <!-- Bullet Navigator -->
      ...
      <div class="col-12 col-lg-2 col-md-4">
                ...
                <div style="display: block; overflow: hidden;border-radius:0.25rem;">
                    ...
                    <!-- Slides Container -->
                        <div data-u="slides" style="position: absolute; left: 0px; top: 0px; width: 167px; height: 100%; overflow: hidden;" class="side_ad_slider">
        ...
        success: function( data ) {
            ...
            for (var i = 0; i < data.length; i++) {
                if(data[i].location == "topbar") {
                    top_ad += '<div class="list-group-item adslist-card" style="padding: 2px;height: 120px;"><a href="/newsdetails/'+data[i].id+'"><img class="img-fluid ads-img" style="width:130px;margin-right: 13.2px;" src="../images/' + data[i].photo + '" /><h3 class="smallads-title text-truncate" style="padding: 10px 0px;height: 90px;">' + data[i].title + '</h3></a></div>';
                } else {
                    side_ad += '<div><a href="/newsdetails/'+data[i].id+'"><img data-u="image" style="width:100%" src="../images/' + data[i].photo + '" /></a></div>';
                }
                
            }
            $(".top_ad_slider").html(top_ad);
            jssor_1_slider_init();
            $(".side_ad_slider").html(side_ad);
            console.log(side_ad);
            jssor_slider2_init();
        }
    });
