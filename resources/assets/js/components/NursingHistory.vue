                                        ...
                                        <div class="card-carousel--card">
                                            <div class="card-carousel--card--footer">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        <td v-for="nur_profile in nur_profiles" :key="nur_profile.id">
                                                            <div class="profile_wd">{{nur_profile.access}}</div>
                                                        </td>
                                                    </tr>
                                                ...
                                                <!-- <tr>
                                                    <td v-for="nur_profile in nur_profiles" :key="nur_profile.id">
                                                        <div class="profile_wd">{{nur_profile.subject}}</div>
                                                    </td>
                                                </tr> -->

                                                    <tr>
                                                        <td v-for="nur_profile in nur_profiles" :key="nur_profile.id">
                                                            <div class="profile_wd">{{nur_profile.occupancy_condition}}</div>
                                                        </td>
                                                    </tr>

                                                     <tr>
                                                        <td v-for="nur_profile in nur_profiles" :key="nur_profile.id">
                                                            <div class="profile_wd">{{nur_profile.township_name}}, {{nur_profile.city_name}}</div>
                                                        </td>
                                                    </tr>
