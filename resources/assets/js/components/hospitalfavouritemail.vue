                    ...
                    <div role="tabpanel" class="tab-pane active" id="input">
                        ...
                        <form class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="count" name="count" class="form-control" placeholder="お名前を入力してください。" required/>
                                <br />
                            </div>

                            <div class="form-group">
                                <label>ふりがな:<span class="error">*</span></label>
                                <input type="text" id="furigana" name="furigana" class="form-control" placeholder="ふりがなを入力してください。" required/>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <autocomplete v-model="post" :source="post_list" ref="autocomplete" results-property="data" defaultOpen="false" placeholder="郵便番号を入力してください。" input-class="form-control postal" @input="addDistributionGroup()" id="postal">
                                    </autocomplete>
                                    <br>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="phone" name="phone" class="form-control" placeholder="電話番号を入力してください。" required>
                                    <br>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="mail" name="mail" class="form-control" placeholder="メールアドレスを入力してください。" required>
                                    <br>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" id="present" name="present" value="早分かり用語集」プレゼントを希望する" required>「早分かり用語集」プレゼントを希望する
                            </div>
                            ...
                            <div class="m-t-30">
                                ...
                                <div class="col-md-6">
                                    <label> 入居対象者様とのご関係<span class="error">*</span></label>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 m-t-30 m-l-10">
                                        <label>お名前:<span class="error">*</span></label>
                                        <input type="text" id="ttname" name="ttname" class="form-control" placeholder="お名前を入力してください。" required>
                                        <br>
                            ...
                            <div class="form-group col-md-9 m-t-30" style="width:;">
                                <label>認知症:<span class="error">*</span></label>
                            ...
                            <button type="button" id="btnSubmit" class="btn btn-primary continue m-l-15" value="submit">Continue</button>
                            ...
                            <div class="col-md-12">
                                ...
                                <form class="col-md-11">
                                    ...
                                    <div style="border:1px solid #dad6d6;padding:30px;border-radius:5px;">
                                        <table class="table">
                                            <tr>
                                                <td class="bk">お名前</td>
                                                <td>
                                                    <input type="text" name="outputSpan" id="outputSpan" class="mailbox" disabled/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="bk">ふりがな</td>
                                                <td>
                                                    <input type="text" name="outputfurigana" id="outputfurigana" class="mailbox" disabled/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name="outputpostal" id="outputpostal" class="mailbox m-b-10" disabled/>
                                                    <div class="m-b-15">都道府県</div>
                                                    <input type="text" name="outputdivision" value="" id="outputdivision" class="mailbox m-b-15" disabled/>
                                                    <div class="m-b-15">市区町村、番地（建物名）</div>
                                                    <input type="text" name="outputcity" id="outputcity" class="mailbox" disabled/>
                                            ...
                                            <tr>
                                                <td class="bk">電話番号</td>
                                                <td>
                                                    <input type="number" name="outputphone" id="outputphone" class="mailbox" disabled/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="email" name="outputmail" id="outputmail" class="mailbox" disabled/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="outputpresent" id="outputpresent" class="mailbox" style="width:276px;" disabled/>
                                                </td>
                                            </tr>
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li>
                                            <button class="btn btn-danger m-t-15"><a href="#" style="color:white;">この内容で送信</a></button>
                                            <a href="#output" aria-controls="output" role="tab" data-toggle="tab" aria-expanded="false"></a>
                                        </li>
                                        <li>
                                            <a href="#review" aria-controls="review" role="tab" data-toggle="tab" aria-expanded="false"></a>
                                    ...
                                    <div style="border:1px solid #dad6d6;padding:30px;border-radius:5px;">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="outputrelation" id="outputrelation" class="mailbox" disabled/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="bk">お名前</td>
                                                <td>
                                                    <input type="text" name="outputttname" id="outputttname" class="mailbox" disabled/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="bk">性別</td>
                                                <td>
                                                    <input type="text" name="outputsex" id="outputsex" class="mailbox" disabled/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="bk">年齢</td>
                                                <td>
                                                    <input type="text" name="outputyears" id="outputyears" class="mailbox" disabled/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="bk">介護度</td>
                                                <td>
                                                    <input type="text" name="outputnursing" id="outputnursing" class="mailbox" style="width:276px;" disabled/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="bk">認知症</td>
                                                <td>
                                                    <input type="text" name="outputfect" id="outputfect" class="mailbox" style="width:276px;" disabled/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="outputdesire" id="outputdesire" class="mailbox" style="width:276px;" disabled/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="outputhope" id="outputhope" class="mailbox" style="width:276px;" disabled/>
                                                </td>
                                            </tr>
