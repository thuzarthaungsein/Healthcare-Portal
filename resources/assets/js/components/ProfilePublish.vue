                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div v-for="(image) in  images" :key="image.id" class="col-sm-4 col-md-4 col-lg-3">
                                <img  :src ="'/upload/nursing_profile/' + image.photo" style="width:100%;border:7px solid #eee;" class="img-responsive" @click="showMultiple()">
                                <VueEasyLightbox
                                    :visible="visible"
                                    :imgs="imgs"
                                    :index="index"
    ...
    data() {
      ...
      showMultiple() {
          for(var i = 0; i<this.images.length; i++){
              this.slide_img[i] = '/upload/nursing_profile/'+this.images[i].photo;              
            //   this.imgs = ['/upload/nursing_profile/'+this.slide_img[i]]
              console.log('thas',this.images)
          }
          
              this.imgs = this.slide_img
          
          console.log('thas',this.slide_img)
    //   this.imgs = ['/upload/nursing_profile/1.jpg','/upload/nursing_profile/aa.png']
      this.index =  this.slide_img[i];; // index of imgList
      this.show()
    },
    show() {
      this.visible = true
