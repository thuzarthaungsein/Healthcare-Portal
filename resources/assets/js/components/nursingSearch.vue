            ...
            <div class="row">
                <div id="job_detail" class="col-md-6 col-sm-12" style="margin-top:20px;" v-for="nus in displayItems" :key="nus.id">
                    ...
                    <div class="row pad-free">
                        ...
                        <span class="btn fav-profile fav-item fav-color" v-if="nus.fav_check == 'check'" :class="'view_pro_id'+nus.nursing_id" style="display:block;" @click="favAddFun('add',nus.nursing_id);">
                            <i class="fas fa-check-double" style="color:#c40000!important;"></i> 追加済み
                          
                        </span>
                         <span class="btn fav-profile fav-item fav-color" v-else :class="'view_pro_id'+nus.nursing_id" style="display:block;" @click="favAddFun('add',nus.nursing_id);">
                           
                            <i class="fas fa-plus-square" style="color:#c40000!important;"></i>&nbsp; お気に入りに追加
                        </span>
                        <span class="btn fav-profile fav-item fav-color" :class="'done_pro_id'+nus.nursing_id" style="color:#aaa;display:none;" @click="favAddFun('remove',nus.nursing_id);"><i class="fas fa-check-double" style="color:#c40000!important;"></i>&nbsp; 追加済み</span>
                        </div>
                    </div>
                    </div>
