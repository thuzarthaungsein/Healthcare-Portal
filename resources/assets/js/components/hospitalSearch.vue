        ...
        <div class="row">
                ...
                <!-- <div class="col-md-7 divisions">
                        <div class="row m-b-30">
                                ...
                                <div class="col-md-3">
                                        <div class="card" style="background: #fab755">
                                                <div class="card-header">
                                                近畿
                                                </div>
                                                <div class="card-body">
                                ...
                                <div class="col-md-3">
                                        <div class="card" style="background: #ec9a9c">
                                                <div class="card-header">
                                                甲信越・北陸
                                                </div>
                                                <div class="card-body">
                                ...
                                <div class="col-md-3">
                                        <div class="card" style="background: #9ac1d6;">
                                                <div class="card-header">
                                                北海道・東北
                                                </div>
                                                <div class="card-body" style="padding: 10px;">                                                 
                        ...
                        <div class="row">
                                <div class="col-md-3">
                                        <div class="card" style="background:#f26d6d;">
                                                <div class="card-header">
                                                九州・沖縄
                                                </div>
                                                <div class="card-body">
                                ...
                                <div class="col-md-3">
                                        <div class="card" style="background: #a2ce4b">
                                                <div class="card-header">
                                                関東
                                                </div>
                                                <div class="card-body">
                                ...
                                <div class="col-md-3">
                                        <div class="card" style="background: #9cd9e0;">                               
                                                <div class="card-header">
                                                四国
                                                </div>
                                                <div class="card-body">                                        
