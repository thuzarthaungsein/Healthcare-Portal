  ...
  <div>
    ...
    <ul class="nav nav-tabs card-head-tabs" role="tablist" id="navtab">
      <li role="presentation" class="subtab1 nav-item">
        <a href="#tab1" role="tab" data-toggle="tab" class="nav-link">
        ...
        <div class="col-12 scrolldiv2 pb-5">
          ...
          <div class="row m-0">
            <form @submit.prevent="add" class="col-md-12 pad-free">
                  ...
                  <div class="row m-0">
                    ...
                    <div class="col-lg-2 col-md-12 mb-5">
                      ...
                      <button
                        ...
                        @click="deleteLocalSto(nur_profile.id)"
                      >最近見た施設から削除</button>
                      <div class="row mt-2">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                          <label class="btn all-btn secondary-bg-color hos-btn">
                            <input
                              ...
                              value="documentation"
                              name="documentation"
                              v-model="document_status[nur_profile.id]"
                              @change="checkSingle()"
                            />
              ...
              <span class="btn all-btn main-bg-color mt-5 float-right" @click="addingMail()">この内容で送信</span>
            </form>
          </div>
        </div>
      </div>
