  ...
  <div class="card profile m-t-22" style="border:none;">
    <form class="col-md-12 form-class">
      <div class="col-md-12 pad-free">
            ...
            <td>
              <div class="form-group">
                ...
                <span
                  class="btn all-btn main-bg-color"
                  style="min-width: 0px;"
                  @click="clinicalSubject()"
                >
                  <i class="fas fa-sort-down animate" :class="{'rotate': isRotate1}"></i>
                </span>
                    ...
                    <div v-for="subj in clinical_subj" :key="subj.id" class="col-md-3 m-b-20">
                      <label>
                        <input
                          type="checkbox"
                          name="subject"
                          v-bind:value="subj.id"
                          @click="subjectCheck(subj.id)"
                          v-model="subj.checked"
                        />
                        {{subj.name}}
                      </label>
                    </div>
        ...
        <table class="table table-bordered table-wrapper">
          <tr>
            <td class="width17" style="border:none;">
              <label class="heading-lbl pad-free">
                医院からのお知らせ
                <span class="error">*</span>
              </label>
            </td>
        ...
        <div class="row col-2 col-offset-6 mx-auto">
          <span
            class="btn secondary-bg-color col-12 all-btn m-t-15 pad-10"
          ...
          .then(response => {
            ...
            if (length > 0) {
              ...
              if (post_data[0]["street"] == "") {
                ...
                this.city =
                  post_data[0]["city"] + " - " + post_data[0]["street"];
              }
