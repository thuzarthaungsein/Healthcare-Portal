...
class HomeController extends Controller
{
    ...
    public function getLatestPostsByAllCatId() {
        ...
        //                 ->get()
        //                 ->toArray();
        $sql = "SELECT categories.name,categories.id,posts.id as pid,posts.title,posts.created_at, posts.photo FROM categories INNER JOIN posts ON categories.id = posts.category_id order by posts.created_at desc";
